...
# INSERT CODE HERE
new_list_no_multiples_of_5 = [x for x in original_list if x % 5 != 0]
#print(new_list_no_multiples_of_5)
...
# INSERT CODE HERE
new_list_half_elements = [x / 2 for x in original_list]
#print(new_list_half_elements)
...
def sort_list_of_lists(lst):
    ...
    for sublist in lst:
        sublist.sort()
    return lst
    # For decreasing order, you can use:
    # for sublist in lst:
...
def split_list(lst, n):
    ...
    """
    # INSERT CODE HERE
    output_lst = [lst[i:i + n] for i in range(len(lst)) if i % n == 0]
    return output_lst
